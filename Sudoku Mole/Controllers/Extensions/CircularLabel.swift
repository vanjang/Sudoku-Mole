...
class CircularLabel: UILabel {
    ...
    */
    func centreArcPerpendicular() {
        ...
        context.translateBy(x: size.width / 2.0, y: size.height / 2)
    ...
    func chordToArc(_ chord: CGFloat, radius: CGFloat) -> CGFloat {
        ...
        // Simple geometry
        // *******************************************************
        return 2 * asin(chord / (2.1 * radius))
    }
    ...
    */
    ...
    func getRadiusForLabel() -> CGFloat {
        ...
        let smallestWidthOrHeight = min(bounds.size.height, bounds.size.width)//*1.3
        ...
        return (smallestWidthOrHeight/2.0) - heightOfFont + 3
    }
}
